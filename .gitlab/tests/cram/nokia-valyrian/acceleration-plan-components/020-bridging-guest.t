...
Remove lan1 from LAN bridge and add it to the Guest bridge:
  ...
  $ printf ' \
  > ubus-cli Bridging.Bridge.lan.Port.cpe-lan1-\n
  > ubus-cli Bridging.Bridge.guest.Port.+{Name="LAN1", Alias="LAN1", LowerLayers="Device.Ethernet.Interface.4."}\n
  > sleep 1\n
...
Remove lan1 from the Guest bridge and add it back to the LAN bridge:
  ...
  > ubus-cli Bridging.Bridge.lan.Port.+{Name="LAN1", Alias="LAN1", LowerLayers="Device.Ethernet.Interface.4."}\n
  > sleep 1\n
