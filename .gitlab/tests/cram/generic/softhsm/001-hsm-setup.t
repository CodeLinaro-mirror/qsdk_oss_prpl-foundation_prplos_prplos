...
Test the creation of a certificate using PKCS11 URIs:
  ...
  $ R "openssl x509 -req -in /tmp/cpe.csr -CA /usr/share/ca-certificates/test/ca.crt -engine pkcs11 -CAkeyform ENGINE -CAkey 'pkcs11:object=ca-key;type=private' -CAcreateserial -out /tmp/cpe.crt -days 3650 -sha256 &> /dev/null"
...
Create client key/cert needed for tests:
  ...
  $ R "openssl x509 -req -in /root/certs/client.csr -CA /usr/share/ca-certificates/test/ca.crt -engine pkcs11 -CAkeyform ENGINE -CAkey 'pkcs11:object=ca-key;type=private' -CAcreateserial -out /root/certs/client.crt -days 3650 -sha256 &> /dev/null"
