...
Check RadioPowerSave configuration defaults:

  $ wifi_dm Radio.*.X_PRPLWARE-COM_RadioPowerSave.?
  Device.WiFi.Radio.1.X_PRPLWARE-COM_RadioPowerSave.Enable=1
  Device.WiFi.Radio.1.X_PRPLWARE-COM_RadioPowerSave.SteerBandPrio="Lowest"
  Device.WiFi.Radio.1.X_PRPLWARE-COM_RadioPowerSave.SteerPeriod=1000
  Device.WiFi.Radio.1.X_PRPLWARE-COM_RadioPowerSave.SteerRetries=1
  Device.WiFi.Radio.2.X_PRPLWARE-COM_RadioPowerSave.Enable=1
  Device.WiFi.Radio.2.X_PRPLWARE-COM_RadioPowerSave.SteerBandPrio="Lowest"
  Device.WiFi.Radio.2.X_PRPLWARE-COM_RadioPowerSave.SteerPeriod=1000
  Device.WiFi.Radio.2.X_PRPLWARE-COM_RadioPowerSave.SteerRetries=1
  Device.WiFi.Radio.3.X_PRPLWARE-COM_RadioPowerSave.Enable=1
  Device.WiFi.Radio.3.X_PRPLWARE-COM_RadioPowerSave.SteerBandPrio="Lowest"
  Device.WiFi.Radio.3.X_PRPLWARE-COM_RadioPowerSave.SteerPeriod=1000
  Device.WiFi.Radio.3.X_PRPLWARE-COM_RadioPowerSave.SteerRetries=1
...
Trigger power save on Radio 1:
  ...
  $ R "ba-cli -l 'Device.WiFi.Radio.1.X_PRPLWARE-COM_SetRadioPowerDown()'" |  sed '/^$/d'
  Device.WiFi.Radio.1.X_PRPLWARE-COM_SetRadioPowerDown() returned
  [
      {
      }
  ]
...
Check radio status:
  ...
  $ wifi_dm "Radio.1.Enable?"
  Device.WiFi.Radio.1.Enable=0
...
Re-enable Radio 1 and check the related vaps status:

  $ R logger -t cram "Enable Radio 1"
  ...
  $ get_radio_ap_status 1
  WiFi.AccessPoint.\d+.Status="Enabled" (re)
  WiFi.AccessPoint.\d+.Status="Enabled" (re)
  WiFi.AccessPoint.\d+.Status="Enabled" (re)
...
Re-enable Radio 1 and check that it's back to default state (Dormant):
